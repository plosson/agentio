...
const realRevolut = await import('../../src/plugins/revolut/oauth');
mock.module('../../src/plugins/jira/oauth', () => ({ ...realJira, refreshJiraToken: jiraRefresh }));
mock.module('../../src/plugins/revolut/oauth', () => ({ ...realRevolut, refreshRevolutToken: revolutRefresh }));

const { getFreshCredentials, REFRESH_BUFFER_MS } = await import('../../src/auth/refresh');
